...
#scp /home/om/Desktop/Cover_Flow_test/cover_flow_raspi_lite.py pi@192.168.2.126:/home/pi/Cover_Flow_test/
...
if os.path.exists(model_path):
    with open(model_path, 'r') as f:
        ...
        if 'raspberry pi' in model:
            # 1. Grafikeinstellungen für Raspberry Pi Lite (muss VOR Kivy-Imports stehen)
            os.environ['KIVY_WINDOW'] = 'sdl2'
            os.environ['KIVY_GL_BACKEND'] = 'gl'
            os.environ['SDL_VIDEODRIVER'] = 'kmsdrm' # Nutzt den DRM/KMS Treiber für die GPU

            # Kivy anweisen, den Framebuffer des Displays zu nutzen

            Config.set('graphics', 'show_cursor', '0')
            Config.set('graphics', 'multisamples', '0') # Wichtig für Performance auf SPI
            Config.set('graphics', 'bits_per_pixel', '4')
...
class MyApp(App):
    def build(self):
        ...
        Window.clearcolor = (1, 1, 1, 1) # Ein dunkles Blau
