...
class MyApp(App):
    def build(self):
        ...
        self.positionen_in_reihenfolge = [
                                            #[60, 60, 30, self.distance_background],
                                            #[60, 80, 30, self.distance_background],
                                            #[60, 100, 30, self.distance_background],
                                            [60, 150, 0, self.distance_foregorund],
                                            #[60, 200, 30, self.distance_background],
                                            #[60, 220, 30, self.distance_background],
                                            #[60, 240, 30, self.distance_background]
        ...
        self.dauer_animation_in_sec  = 0.2
        ...
        for i in range(self.index_of_upper_cover, len(self.positionen_in_reihenfolge)):
            ...
            self.widgets[i].change_position(new_x=60, new_y=150)
            i_, v_1, v_2, v_3 = self.widgets[i].foward_lean(100, 120, 30, self.widget_breite, self.resolution_)
        ...
        x_1, y_1, angle_1, distance_1 = 60, 150, 30, 120
        x_2, y_2, angle_2, distance_2 = 60, 100, 0, 100
        ...
        for s in range(self.frames_per_animation):
            ...
            distance_s = distance_2 - s * d_distance_per_frame
            idices, vertices_1, vertices_2, vertices_3 = self.widgets[0].foward_lean(100, distance_s, angle_s, self.widget_breite, self.resolution_)
